        ...
        try {
            if (command.equals("Effacer")) {
                ...
                try {
                    ...
                    lblResultatFormulaire.setText("ERREUR! L'année et les pages doivent être des nombres.");
                    return;
                }

                // Ici, vous ajouterez la logique pour vérifier si le livre existe dans la base de données
                // et procéder à la suppression réelle.
